...
AGENT = "http://192.168.1.4:5000/" # MTConnect agent ip:port
...
if __name__ == "__main__":
    model_file = "20260407_182820_Prelab10_CNN_model1.h5"
   ...
   #     yhat = interpreter.get_tensor(output['index']) # model output as yhat
        ...
        print(f"Prediction: {prediction_label} | Confidence: {np.max(yhat):.4f}")
