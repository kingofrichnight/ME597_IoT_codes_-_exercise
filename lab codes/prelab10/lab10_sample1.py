...
CHUNK = 2048 # chunk size (ro Count/sequence)
# AGENT = "http://mepotrb16.ecn.purdue.edu:5001/" # MTConnect agent ip:port
AGENT = "http://192.168.1.4:5000/"
N = 23 # number of sequence to take sound
N_FFT = 2024 # number of FFT
...
print("Length of signal is ", len(signal)/SAMP_RATE, "[sec]")
