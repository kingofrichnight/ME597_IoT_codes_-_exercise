...
filename = "speedH_Abnormal_lab8_data.csv" # input your filename
...
your_name = "Aarya" # input your name
rpm = "3000 rpm" 
Time_title = "Time domain, "+condition+", "+rpm +", "+your_name
Freq_title = "Freq domain, "+condition+", "+rpm +", "+your_name
